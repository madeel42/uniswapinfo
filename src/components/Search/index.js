...
import { useAllPairsInKwikswap, useAllTokensInKwikswap } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInKwikswap()
  const allTokenData = useAllTokenData()

  let allPairs = useAllPairsInKwikswap()
        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search Kwikswap pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
